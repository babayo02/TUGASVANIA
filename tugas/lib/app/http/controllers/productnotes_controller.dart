...
import 'package:tugas/app/models/productnotes.dart';
...
class ProductNotesController extends Controller {
  ...
  Future<Response> update(Request request, String id) async {
    try {
      ...
      await Productnotes().query().where('note_id', '=', id).update(productNoteData);
  ...
  Future<Response> destroy(Request request, dynamic id) async {
    try {
      ...
      final productNote = await Productnotes().query().where('note_id', '=', noteId).first();
